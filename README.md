...
- Route input normalization and ambiguity feedback for airport codes, city names, via stops, and natural-language connectors
...
- `references/input-understanding.md` — route normalization, ambiguity handling, and malformed-input feedback
